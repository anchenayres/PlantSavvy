      ...
      <View key={index} style={styles.faqItem}>
        <TouchableOpacity onPress={() => toggleExpansion(index)}>
          <View style={styles.questionContainer}>
            ...
            {expandedIndex === index ? (
              <FontAwesome5 name="pagelines" size={20} color="#0B4D21" />
            ) : (
              <FontAwesome5 name="pagelines" size={25} color="#0B4D21" />
            )}
          </View>
        </TouchableOpacity>
        {expandedIndex === index && (
